    ...
    if option=="T":
        ...
        while tamaño<=7:
            ...
            if mina==0:
                ...
                numMinas=numMinas+1
            tamaño=tamaño+1
        print("¡Tablero Generado! Se ha encontrado",numMinas,"minas.")
    elif option=="J":
        print("Jugando...")
        intentos=int(input("Introduce el número de intentos que quieres tener: "))
        print("Tiene que encontrar",numMinas,"minas en",intentos,"intentos")
        puntuacion=0
        while rep1:
